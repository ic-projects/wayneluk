...
private:
    ...
    void _bgezal(uint32_t regs, int16_t imm);
    void _bgtz(uint32_t regs, int16_t imm);
    void _blez(uint32_t regs, int16_t imm);
    void _bltz(uint32_t regs, int16_t imm);
    void _bltzal(uint32_t regs, int16_t imm);
    void _bne(uint32_t regs, uint32_t regt, int16_t imm);
    void _div(uint32_t regs, uint32_t regt);
    void _divu(uint32_t regs, uint32_t regt);
    void _j(uint32_t target);
    void _jal(uint32_t target);
    void _jalr(uint32_t regs, uint32_t regd);
    void _jr(uint32_t regs);
    void _lb(uint32_t regs, uint32_t regt, int16_t imm);
